...
pub(crate) const CONSENSUS_BRANCH_IDS: &[(NetworkUpgrade, ConsensusBranchId)] = &[
    ...
    // Match the temporary NU7 branch ID used by the Zebra NU7 configured testnet branch.
...
/// The target block spacing after NU7 activation on the configured testnet.
...
impl NetworkUpgrade {
    ...
    pub fn target_spacing(&self) -> Duration {
        let spacing_seconds = match self {
            ...
            Blossom | Heartwood | Canopy | Nu5 | Nu6 | Nu6_1 => POST_BLOSSOM_POW_TARGET_SPACING.into(),
